  ...
  return (
    <StyleBlogCard className="card card-blog">
      ...
      <StyleBlogBody className="card-body">
        <StyleInfo>
          <StyleItemInfo><span className="text">By: Chris Jordan</span></StyleItemInfo>
          <StyleItemInfo><span className="icon"><CalenderIcon /></span><span className="text">Aug 10, 2025</span></StyleItemInfo>
          <StyleItemInfo><span className="badge">Commercial Building</span></StyleItemInfo>
        </StyleInfo>
